...
function calculate_shortcode( $atts ) {
    ...
    echo '
        ...
        <div class="c-wrap">
            <div class="c-boxes">
                <div class="c-box">
                    <div class="c-value">$'.number_format($annual_cost, 0, '.', ',').'</div>
                    <span>Annual cost of processing manually</span>
                </div>
                <div class="c-box">
                    <div class="c-value"> $'.number_format($labour_cost, 0, '.', ',').'</div>
                    <span>Labour cost once automated</span>
                </div>
                <div class="c-box">
                    <div class="c-value"> $'.number_format($total_annual_cost, 0, '.', ',').'</div>
                    <span>Total annual cost (post automation)</span>
                </div>
            </div>  
            <div class="c-boxes">
                <div class="c-box">
                    <div class="c-value"> '.number_format($roi, 1, '.', ',').'</div>
                    <span>ROI</span>
                </div>
                <div class="c-box">
                    <div class="c-value"> $'.number_format($operational_cost_saving_per_year, 0, '.', ',').'</div>
                    <span>Operational cost saving per year</span>
                </div>fac
                <div class="c-box">
                    <div class="c-value"> '.number_format($time_saving_hours_per_year, 1, '.', ',').'</div>
